...
<p align="center">
    <img alt="Typing animation introducing Janitha Gamage" src="https://readme-typing-svg.herokuapp.com/?font=cursive&size=35&center=true&vCenter=true&width=900&height=80&duration=5000&lines=Hello+Folks!+🌍;+I'm+Janitha+Gamage!+🤠;+Emerging+Developer+and+Product+Strategist+💼;+FullStack+Developer+👨‍💻;+Software+Engineering+Undergratuate+🎓;+Postman+Student+Expert+✏️;" />
<p>
...
![Kotlin](https://go-skill-icons.vercel.app/api/icons?i=kotlin)
![Dart](https://go-skill-icons.vercel.app/api/icons?i=dart)
...
![Next.js](https://go-skill-icons.vercel.app/api/icons?i=next)
![Tailwind](https://go-skill-icons.vercel.app/api/icons?i=tailwindcss)

### 🔧 Backend & APIs

![Node.js](https://go-skill-icons.vercel.app/api/icons?i=nodejs)
![Express](https://go-skill-icons.vercel.app/api/icons?i=expressjs)
...
![GCP](https://go-skill-icons.vercel.app/api/icons?i=gcp)
...
| ---------------------- | ------------------------------------------------------------------ | ------------------ | ---------------------------------------------------------- |
| **FoodieFly**          | Cloud-native food ordering & delivery platform using microservices | MERN, Docker, REST | [Repo](https://github.com/JordanCJ7/FoodieFly)             |
| **Flashboard Central** | Centralized web app showcasing Flashboard products and roadmap     | React, Node.js     | [Repo](https://github.com/JordanCJ7/FlashBoard-Wiki)       |
...
* 🎖 **Postman API Fundamentals – Student Expert** (Apr 2025)
...
<p align="center">
  <a href="https://github.com/ryo-ma/github-profile-trophy">
    <img align="center" src="https://github-profile-trophy-ruddy-three.vercel.app/?username=JordanCJ7&theme=onedark&icon=classic" alt="GitHub Profile Trophies">
  </a>
</p>
